...
2. Read `$OBSIDIAN_VAULT_PATH/kb/wiki/index.md` to understand the wiki's scope and structure
3. **Set `WIKI_DIR=kb/wiki`** — all wiki files live under this subdirectory, not at vault root
